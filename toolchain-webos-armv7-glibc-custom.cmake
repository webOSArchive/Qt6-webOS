...
# Uses custom-built glibc 2.27 with kernel 2.6.16 support
...
# Bootlin toolchain for compilers
set(GLIBC_TOOLCHAIN "$ENV{HOME}/toolchains/armv7-eabihf--glibc--bleeding-edge-2018.07-1")
set(TOOLCHAIN_PREFIX "arm-buildroot-linux-gnueabihf")

# Compilers
set(CMAKE_C_COMPILER "${GLIBC_TOOLCHAIN}/bin/${TOOLCHAIN_PREFIX}-gcc")
set(CMAKE_CXX_COMPILER "${GLIBC_TOOLCHAIN}/bin/${TOOLCHAIN_PREFIX}-g++")
set(CMAKE_ASM_COMPILER "${GLIBC_TOOLCHAIN}/bin/${TOOLCHAIN_PREFIX}-gcc")
set(CMAKE_AR "${GLIBC_TOOLCHAIN}/bin/${TOOLCHAIN_PREFIX}-ar")
set(CMAKE_RANLIB "${GLIBC_TOOLCHAIN}/bin/${TOOLCHAIN_PREFIX}-ranlib")
set(CMAKE_STRIP "${GLIBC_TOOLCHAIN}/bin/${TOOLCHAIN_PREFIX}-strip")
set(CMAKE_LINKER "${GLIBC_TOOLCHAIN}/bin/${TOOLCHAIN_PREFIX}-ld")
set(CMAKE_NM "${GLIBC_TOOLCHAIN}/bin/${TOOLCHAIN_PREFIX}-nm")
set(CMAKE_OBJCOPY "${GLIBC_TOOLCHAIN}/bin/${TOOLCHAIN_PREFIX}-objcopy")
set(CMAKE_OBJDUMP "${GLIBC_TOOLCHAIN}/bin/${TOOLCHAIN_PREFIX}-objdump")

# Use original toolchain sysroot for compilation (headers work correctly)
# Our custom glibc (kernel 2.6.16) will be deployed at runtime
set(CMAKE_SYSROOT "${GLIBC_TOOLCHAIN}/${TOOLCHAIN_PREFIX}/sysroot")

# Search paths
set(CMAKE_FIND_ROOT_PATH "${CMAKE_SYSROOT}")

# Compiler flags for webOS/HP TouchPad (ARMv7-A, Scorpion core)
# Using hard-float ABI, Qualcomm Scorpion supports VFPv3 + NEON
set(WEBOS_COMPILER_FLAGS "-march=armv7-a -mfpu=neon-vfpv3 -mfloat-abi=hard -mtune=cortex-a8")
